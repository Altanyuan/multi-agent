...
import com.aitanyuan.multi.agent.model.TaskPlan;
...
public class OrchestratorAgent {
     ...
     */
    public List<WorkerResult> process(String userMessage, String conversationId) throws Exception {
        ...
        for (TaskPlan.SubTask subTask : plan.subTasks()) {
            futures.add(executor.submit(() -> {
                ...
                return new WorkerResult(subTask.id(), subTask.assignedAgent(), result, requiresEscalation);
            }));
        }
