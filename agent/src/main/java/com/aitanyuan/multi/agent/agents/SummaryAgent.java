...
public class SummaryAgent {
    ...
    public SummaryAgent(ChatClient.Builder chatClientBuilder, ObjectMapper objectMapper) {
     ...
     * @param workerResults   所有 Worker Agent 的执行结果
     * @return 整合后的客服响应
     */
    public CustomerResponse summarize(String originalRequest, List<WorkerResult> workerResults) {
        try {
            ...
            boolean anyEscalation = workerResults.stream().anyMatch(WorkerResult::requiresEscalation);
